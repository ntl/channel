      ...
      def call
        context "Value: #{input.inspect}" do
          context "Dump and Load" do
            value = Channel::Value.new(input)

            detail "Raw Data: #{value.data.inspect} (#{value.size} bytes)"

            context "Restore Value" do
              previous_bytes_transferred = Channel::Value.bytes_transferred
              ...
              test "Byte transfer count" do
                ...
                bytes_transferred = Channel::Value.bytes_transferred
